 window.phoneNumber = "";
  ...
  function confirmPhone() {
    var userInput = prompt("Enter the secret code to confirm the phone number:\n Hint: one of Michael Jordans jersey numbers + Universe code of the citadel of Ricks times the 38th digit of Pi squared. Now find a factor of that number you just found and thats the answer");
